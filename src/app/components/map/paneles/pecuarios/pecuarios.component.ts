...
import { pecuarios } from 'src/app/common/data/pecuarios';
import { pecuarios as cultivos } from 'src/app/common/data/cultivos';
import { ChartOptions } from 'chart.js';
import * as XLSX from 'xlsx';

@Component({
  selector: 'app-pecuarios',
  templateUrl: './pecuarios.component.html',
  styleUrls: ['./pecuarios.component.css']
})
export class PecuariosComponent {
  ...
  cambiarMunicipio() {
    const muni = pecuarios.filter(
      (f:any) => f.codigo_mun == +this.municipioSeleccionado
    );
  ...
  exportexcel() {
    ...
    const nombreArchivo = 'datos-pecuarios.xlsx';
    ...
    XLSX.utils.book_append_sheet(wb, ws, 'datos pecuarios');
